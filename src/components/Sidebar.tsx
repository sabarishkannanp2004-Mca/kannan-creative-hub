          ...
          <div className="text-center mb-12 animate-fade-in">
            ...
            <div className="flex justify-center gap-3 mt-4 flex-wrap">
              <a
                ...
                className="text-navy hover:text-purple transition-colors hover:scale-110 transform"
                title="LinkedIn"
              >
              ...
              <a
                ...
                title="Naukri"
              >
                <img src="https://static.naukimg.com/s/0/0/i/new-homepage/apple-touch-icon.png" alt="Naukri" className="w-5 h-5 rounded" />
              </a>
              <a
                ...
                title="HackerRank"
              >
                <img src="https://hrcdn.net/fcore/assets/favicon-ddc852f75a.png" alt="HackerRank" className="w-5 h-5 rounded" />
              </a>
            </div>
          </div>
