      ...
      >
        <div className="flex flex-col h-full p-8">
          ...
          <div className="text-center mb-12 animate-fade-in">
            <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple to-light-purple p-1">
              <div className="w-full h-full rounded-full bg-card flex items-center justify-center">
                <span className="text-4xl font-bold text-purple">SK</span>
              </div>
            </div>
            <h2 className="text-2xl font-bold text-navy mb-1">Sabarish Kannan P</h2>
              ...
              {menuItems.map((item, index) => (
                ...
                >
                  <a
                    ...
                    className="flex items-center gap-3 px-4 py-3 rounded-xl text-foreground hover:bg-secondary hover:text-primary transition-all group"
                  >
